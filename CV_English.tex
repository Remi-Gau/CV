...
\textbullet~GAU R, NOPPENEY U; \href{}{The left prefrontal cortex controls information integration by combining bottom-up inputs and top-down predictions}, Annual meeting of the Society for neurosciences, San Diego, (California, USA), 2013, %361.10/BB36 
...
\item [\textbullet~Softwares:] Proficient use \& knowledge of : matlab, PsychToolBox, Preseantation, SPM, UNIX operating system, Spike 2 (electrophysiology), MIPAV, Freehand \& Inkscape (vectorial drawing), Photoshop \& Gimp, Latex, Microsoft/Libre Office. Good use \& knowledge of different statistic analysis softwares (SPSS, statisticA, Statview, SigmaPlot), Image J. Some use \& knowledge MRIcro, C/C++.

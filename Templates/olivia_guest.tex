...
\begin{description}
 \item[Email:] \href{mailto:o.guest@ucl.ac.uk}{o.guest@ucl.ac.uk}
...
\textbf{Ph.D.} \emph{Towards a Unified Computational Account of Semantic Impairments}  \hfill \textbf{2014}
\begin{outerlist}
    \item [\href{http://www.bbk.ac.uk/}{Birkbeck}, UK. Supervisors: \emph{Richard P. Cooper}, \emph{Eddy J. Davelaar}]
\end{outerlist}
\vspace{15pt}

\textbf{M.Sc.} Cognitive and Decision Sciences (Distinction) \hfill \textbf{2010}
\begin{outerlist}
     \item [\href{http://www.ucl.ac.uk/}{University College London}, UK.]
\end{outerlist}     
\vspace{15pt}

\textbf{B.Sc.} Computer Science \hfill \textbf{2009}
\begin{outerlist}
  \item[\href{http://www.york.ac.uk/}{The University of York}, UK.]
\end{outerlist}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EMPLOYMENT\texorpdfstring{\newline}{ }HISTORY}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \textbf{\href{https://www.ru.nl/donders/}{Donders Centre for Cognitive Neuroimaging}, Netherlands}
  \begin{outerlist}
  \item[\textit{Postdoctoral Researcher}] \hfill \textbf{2020--}
    
%   \begin{innerlist}
%     \item Deep neural network models of concepts and of face processing. 
%     \item Funded by EU Horizon 2020, and the Republic of Cyprus.
%   \end{innerlist}
...
%   \item[\textbf{Research Centre on Interactive Media, Smart Systems and Emerging Technologies}]
  \item[\textit{Independent Researcher}] \hfill \textbf{2019--2020}
...
%   \begin{innerlist}
%     \item Deep neural network models of categorisation, and in model-based fMRI.
%     \item Worked with \href{https://www.ucl.ac.uk/pals/research/experimental-psychology/person/bradley-love/}{Brad Love}.
%   \end{innerlist}
  \end{outerlist}
  \end{samepage}
...
%   \begin{innerlist}
%     \item Computational modelling of category learning in infancy
%     \item Worked with \href{https://www.psy.ox.ac.uk/team/kim-plunkett}{Kim Plunkett}.
%   \end{innerlist}
\end{outerlist}
  \vspace{15pt}
  \end{samepage}
...
\begin{outerlist}
 ...
 \item[\textbf{Conferences (ad hoc reviewing)}] \hfill
  ...
  International Conference on Cognitive Modelling (ICCM), International Conference on Machine Learning (ICML), Scientific Computing with Python Conference (SciPy), EnviroInfo.
  
   \item[\textbf{Journals (ad hoc reviewing)}] \hfill
    
    Cognitive Science Journal, Cognitive Psychology, Memory \& Cognition, PLoS Computational Biology, Journal of Cognitive Neuroscience, PeerJ.
...
\paper{Love, B. C., Kopeć, Ł. \& \textbf{Guest, O.} (2015). \href{http://dx.doi.org/10.1371/journal.pone.0137685}{Optimism Bias in Fans and Sports Reporters}. \textit{PLoS ONE}, 10 (9).
\href{http://dx.doi.org/10.1371/journal.pone.0137685}{doi.org/10.1371/journal.pone.0137685}}{We asked NFL fans to predict how many games teams they like and dislike would win in the 2015 season.
...
Whitaker, K. J. \& \textbf{Guest, O.} (in press).  {\#bropenscience is broken science} \textit{The Psychologist}.
\vspace{8pt}
